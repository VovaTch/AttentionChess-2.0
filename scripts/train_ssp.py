...
def main(config):
    ...
    data_loader = config.init_obj('data_loader', module_data, collate_fn=collate_fn, engine=copy.deepcopy(model))
...
if __name__ == '__main__':
    ...
    args.add_argument('-c', '--config', default='config/config_ssp.yaml', type=str,
